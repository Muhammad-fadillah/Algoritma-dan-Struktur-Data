...
int main() 
{
    do {
        ...
        switch(pil) {
            ...
            case 3:
                hapusDepan ();
                cout<<"Data \""<<deleteData<<"\" yang berada didepan telah berhasil dihapus. "<<endl;
                break;
            case 4:
                hapusBelakang();
                cout<<"Data \""<<deleteData<<"\" yang berada di belakang telah berhasil dihapus." << endl;
                break;
            case 5:
                tampilkan();
                break;
            ...
            default:
                cout << "\nTERIMA KASIH" << endl;
                cout << "Program was made by Muhammamd Fadillah (2410817210001)." << endl;
            }
            ...
            do {
                if(cari == bantu->data){
                    cout<<"Setiap data yang berada di dalam tanda kurung siku ([...]) "
                        <<"merupakan data yanng anda cari."<<endl;
                    cout<<"Linked List : ";
                    bantuTampilkan = head;
                ...
                if(apaDitemukan == false)
                    cout<<"Data\""<<cari<<"\" tidak ditemukan pad Linked List."<<endl;
            } else cout<<"Tidak terdapat data pada Linked List."<<endl;
        }    
    ...
    void sisipkanSebelum() {
        if(isEmpty() == 0) {
            ...
            if (apaAda==true) {
                ...
                cout<<"Tidak terdapat data\""<<nextData<<"\"pada Linkedd List."<<endl;
            }
        } else cout<<"Tidak terdapat data pada Linked List."<<endl;  
    }
    ...
    void sisipkanSetelah() {
        if(isEmpty() == 0) {
            ...
            if(apaAda==true) {
                cout<<"Masukkan data yang ingin ditammbahkan : ";
                cin>>dataBaru;
                ...
                cout << "Data \""<<dataBaru<<"\" berhaisl disisipkansetelah data \""<<prevData<<"\"."<<endl; 
            } else {
