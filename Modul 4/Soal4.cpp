...
int main() 
{
    ...
    cout << "====================" << endl;
    cout << "Silahkan pilih program DLLNC yang ingin dinjalankan"<<endl;
   ...
   system("cls");
    if (menu == 1) {
        do {
            cout << "Doble Link List Non Circular (DLLNC) (Head)" << endl;
            cout << "====================" << endl;
            ...
            cout <<"\npress any key to conticue"<<endl;
            getch();
            system("cls");
        ...
        do {
            cout << "Doble Link List Non Circular (DLLNC) (Head & Tail)" << endl;
            cout << "====================" << endl;
            cout << "1. Tambah Depan" << endl;
            cout << "2. Tambah Belakang" << endl;
            cout << "3. Tampilkan Data" << endl;
        ...
        cout<<"\nTERIMA KASIH"<<endl;
        cout<<"\nProgram was made by Muhammad Fadillah (2410817210001)."<<endl;
    } 
}
